...
def detail_url(rec_id):
    return reverse('recipe:recipe-detail', args=[rec_id])
...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_retrieve_recipe_detail(self):
        ...
        recipe_serializer = RecipeDetailSerializer(recipe)
        self.assertEqual(res.data, recipe_serializer.data)


    # test create recipes 
    def test_create_basci_recipes(self):
        payload = {
    ...
    def test_partial_update_recipe(self):
        ...
        # print([tag.id for tag in recipe.tags.all()]+[new_tag.id])
        payload = {
            'title':'blah blah',
            'tags': [tag.id for tag in recipe.tags.all()]+[new_tag.id]
        }
        url = detail_url(recipe.id)
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_upload_image_to_recipe(self):
        """ test uploading an image to recipe  instance"""
